class Game {
    constructor(images, sounds){
        ...
        this.goombaDieImages = loadGoombaImages(this.images.goombaImg)
        ...
        this.startButton = createButton('Go')
        this.startButton.mousePressed(this.init)
        this.startScreen = new Overlay(`Puffy`, '', this.startButton)
        this.gameOverScreen = new Overlay('Retry', 'Oop!', this.startButton)
        this.died = false 
    }
